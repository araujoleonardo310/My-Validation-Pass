<h1>Projeto: My Validation Password 🔓</h1>
...
<p>Tela animada de validação e força de senha</p>
...
✔️ Animação progresso de força de senha

✔️ Utilização de atributos Bootstrap
...
<div align=center>
    ...
    <br>
    <h4>Tela<h4>
    <img src="./project/gifs/my-validation-pass.gif">
</div>
